...
configs = {
    ...
    'vocab_path': path.sep.join([BASE_DIR, 'model/pretrain/ernie_base/vocab.txt']),
    'ernie_config_file': path.sep.join([BASE_DIR, 'model/pretrain/ernie_base/ernie_config.json']),
    'pytorch_model_path': path.sep.join([BASE_DIR, 'model/pretrain/ernie_base/pytorch_model.bin']),
    'ernie_model_dir': path.sep.join([BASE_DIR, 'model/pretrain/ernie_base']),
